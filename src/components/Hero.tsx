    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          className="relative aspect-square flex items-center justify-center animate-float-delayed"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 to-emerald-500/20 rounded-[3rem] blur-3xl animate-[pulse_6s_infinite]" />
          <div className="relative group">
            <div className="absolute -inset-2 bg-gradient-to-r from-blue-400 to-emerald-400 rounded-full blur-xl opacity-60 group-hover:opacity-100 transition duration-500 animate-[pulse_4s_infinite]" />
            <Logo className="relative h-64 w-64 md:h-96 md:w-96 rounded-full border border-white/30 shadow-[0_0_80px_rgba(34,197,94,0.4)] bg-neutral-900 drop-shadow-[0_0_50px_rgba(59,130,246,0.6)] bg-gradient-to-br from-neutral-800 to-neutral-900" />
          </div>
          ...
          <motion.div
            ...
            className="absolute top-10 right-4 px-6 py-4 rounded-3xl bg-neutral-800/80 backdrop-blur-xl border border-white/20 shadow-[0_0_30px_rgba(0,0,0,0.5)]"
          >
            <div className="flex items-center gap-3">
              <div className="p-3 bg-emerald-500/20 rounded-xl border border-emerald-400/30 shadow-[0_0_15px_rgba(16,185,129,0.3)]">
                <TrendingUp className="text-emerald-400" size={20} />
              </div>
              <div>
                <p className="text-xs text-neutral-400 font-medium">Уровень ER</p>
                <p className="font-bold text-white transition-all text-lg drop-shadow-md">35.4%</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute bottom-20 -left-10 px-6 py-4 rounded-3xl bg-neutral-800/80 backdrop-blur-xl border border-white/20 shadow-[0_0_30px_rgba(0,0,0,0.5)]"
          >
            <div className="flex items-center gap-3">
              <div className="p-3 bg-blue-500/20 rounded-xl border border-blue-400/30 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                <ShieldCheck className="text-blue-400" size={20} />
              </div>
              <div>
                <p className="text-xs text-neutral-400 font-medium">Доверие аудитории</p>
                <p className="font-bold text-white text-lg drop-shadow-md">92%</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
