        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-3 rounded-full bg-white/5 hover:bg-blue-600 transition-all">
                <Send size={20} />
              </a>
              <a href="#" className="p-3 rounded-full bg-white/5 hover:bg-neutral-800 transition-all">
                <Mail size={20} />
              </a>
            </div>
          </div>
