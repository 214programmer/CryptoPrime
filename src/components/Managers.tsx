...
export const Managers: React.FC = () => {
  return (
    <section id="managers" className="py-24 relative">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative group bg-neutral-900 border border-white/10 rounded-[2rem] overflow-hidden hover:border-emerald-500/50 transition-all shadow-[0_0_40px_rgba(0,0,0,0.5)] mb-12"
        >
